This is a replica of the website tindog (https://play.google.com/store/apps/details?id=com.tindog.tindog&hl=en_US&gl=US) that I created using HTML, CSS, and Bootstrap. 
